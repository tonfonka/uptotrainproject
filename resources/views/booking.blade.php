              ...
              <?php 
                ...
                <form action="/bookingsum" method="POST" name="id">
                  ...
                  <table class="table">
                    <tr>
                      <td> จำนวนเด็ก </td>
                      <td><input type="number" name="number_children" id="number_children" min="0" max={{$sum}} value="0"> ราคา
                        :: {{$triprounds->price_child}}</td>
                      <td>
                        <h3 id="pchild"></h3>
                      </td>
                    </tr>
