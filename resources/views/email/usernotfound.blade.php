...
body {
    ...
    background: url("{{ asset('img/notfound.jpg') }}")no-repeat center 0px;
	...
	<div class="agileits-main"> 
		<div class="agileinfo-row">
			...
			<div class="w3layouts-errortext">
				...
				<p class="w3lstext">You have been tricked into click on a link that can not be found. Please check the url or go to <a href="/">home page</a> and see if you can locate what you are looking for </p>
