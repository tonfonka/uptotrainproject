...
<html>
  <head>
    ...
    <title>You're invited!</title><!-- Designed by https://github.com/kaytcat -->
    ...
    <style media="screen" type="text/css">
      @media screen {
        ...
        /* Thanks Outlook 2013! */
        * {
          font-family: 'Prompt', 'Helvetica Neue', 'Arial', 'sans-serif' !important;
        }
        .w280 {
                  ...
                  <tr >
                    <td align="center"  valign="top">
                      <table cellpadding="0" cellspacing="0"  style="margin:0 auto;" width="100%">
                        <tbody >
                          <tr >
                            <td bgcolor="#58585B"  style="text-align: center;">
                      ...
                      <table cellpadding="0" cellspacing="0" style="background-color:#58585b;" width="100%">
                        <tbody>
                          <tr >
                                ...
                                <tbody >
                                  ...
                                  <tr>
                                    <td class="w320 mobile-spacing" 
                                      ...
                                      Please click this button to verify account<br>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                          ...
                          <tr>
                            <td style="background-color:#ffffff;">
                              ...
                              <table cellpadding="0" cellspacing="0" width="100%">
                                <tbody>
                                  <tr>
                                    <td class="mobile-center body-padding w320" style="text-align:left;">
                                      <br>
                                      <center >
                                      </center>
                                    </td>
                              ...
                              <table cellpadding="10" cellspacing="0" style="margin:0 auto;" width="100%">
                                <tbody>
                                  <tr>
                              ...
                              <table bgcolor="#363636" cellpadding="0" cellspacing="0" class="force-full-width">
                                <tbody>
                                  <tr>
                                    <td  style="background-color:#58585b; text-align:center;">
                                    </td>
                                  </tr>
