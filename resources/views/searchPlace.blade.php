      ...
      <div class="container">
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal{{$p->id}}">
            ...
            <img src="/img/{{$p->pic}}" alt="Tattoo &amp; Piercing" width="350" height="250" style="display: block; border: 0;" />
          </a>
                  ...
                  <div class="col-lg-12 mx-auto">
                    <div class="modal-body">
                      ...
                      <ul class="list-inline">
                        <li>เวลาเปิดทำการ : {{$p->attraction_Time_Open}}</li>
                        <li>เวลาปิดทำการ : {{$p->Attraction_Time_Closed}}</li>
                        <li>เบอร์โทรศัพท์ติดต่อ : {{$p->Attraction_Tel}}</li>
                      </ul>
